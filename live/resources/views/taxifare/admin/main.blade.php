                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    @if(!empty(Auth::guard('admin')->user()->image)){
                                       {{-- {{ Html::image(Storage::url($userImage))}} --}}
                                       {{Html::image('')}}
                ...
                @if(Auth::guard('admin')->user())
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="javascript::void(0)">Add New Client</a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{ url('#') }}">All Drivers</a></li>
                        </ul>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{ url('admin/compose-mail') }}">Compose New Mail</a></li>

                            <li><a href="{{ url('admin/taxi-booking') }}">Inbox</a></li>
                            <li><a href="{{ url('admin/mail-sent') }}">Mail Sent</a></li>
