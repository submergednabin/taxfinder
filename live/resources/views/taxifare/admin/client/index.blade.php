                ...
                <div class="box-body">
                    <div class="table-reponsive">
                        <table id="example1" class="table table-bordered table-striped user-list">
                            ...
                            <tbody>
                            @foreach($allClient as $user)
                                <tr>
                                    <td>{{ $user->first_name?$user->first_name:'N/A' }}</td>
                                    <td>{{ $user->middle_name?$user->middle_name:'N/A' }}</td>
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="{{ url('admin/client/edit/'.$user->id) }}">
                                            <i class="flaticon-edit"></i>
                                        </a>

                                        <form action="{{url('admin/client/destroy/'.$user->id)}}" method="DELETE" class="delete-user-form">
                                            {!! csrf_field() !!}
